...
import uguess.qucai.com.merchant.business.common.ui.PictureViewPagerActivity;
...
public class PhotoView extends ImageView implements IPhotoView {
    ...
    private PictureViewPagerActivity mActivity;
    ...
    public PhotoView(Context context, AttributeSet attr, int defStyle) {
        ...
        mActivity = (PictureViewPagerActivity) context;
        mAttacher = new PhotoViewAttacher(this,this.getmActivity());
    ...
    public PictureViewPagerActivity getmActivity() {
        return mActivity;
    }
}