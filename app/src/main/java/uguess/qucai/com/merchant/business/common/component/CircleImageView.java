...
public class CircleImageView extends ImageView implements View.OnClickListener {
    ...
    private boolean closeDefaultClick = false;
...
//        if (!closeDefaultClick) {
//            String currentUserId = Cache.getInstance().getUser().getUserId();
//            if (!TextUtils.isEmpty(userId) && !currentUserId.equals(userId)) {
//                Intent i = new Intent(mContext, SearchUserDetailActivity.class);
//                i.putExtra(Const.Intent.USER_ID, userId);
...
//        }
    ...
    public void setCloseDefaultClick(boolean closeDefaultClick) {
        this.closeDefaultClick = closeDefaultClick;
    }
}