...
public class HttpComm {
    ...
    private void postEvent(String result) {
        if (this.mCallback != null) {
            this.mCallback.onResponse(result != null ? HttpResultCallback.HttpDownloaderResult.eSuccessful : HttpResultCallback.HttpDownloaderResult.eNone, this.mUrl, result);
        }
    }
