...
public class BaseFragmentV4 extends android.support.v4.app.Fragment {
     ...
     * @param fragment
     */
    protected void replaceFragment(int id, android.support.v4.app.Fragment fragment) {
    ...
    protected void removeFragment(int id) {
        ...
        if (((BaseFragmentActivityV4) getActivity()).isActyDestroyed()) {
            return;
        }
        android.support.v4.app.Fragment fragment = findFragment(id);
        if (fragment != null) {
     ...
     * @return
     */
    protected android.support.v4.app.Fragment findFragment(int id) {
