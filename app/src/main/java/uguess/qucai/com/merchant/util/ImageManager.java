...
public class ImageManager {
    ...
    private static DisplayImageOptions getDefaultCacheDisplayOption() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.common_default_photo) // resource or drawable
                .showImageForEmptyUri(R.drawable.common_default_photo) // resource or drawable
                .showImageOnFail(R.drawable.common_default_photo) // resource or drawable
                .cacheInMemory(true)
                .cacheOnDisk(true)
                .build();
        return options;
    ...
    private static DisplayImageOptions getPortraitDisplayOption() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.default_portrait) // resource or drawable
                .showImageForEmptyUri(R.drawable.default_portrait) // resource or drawable
                .showImageOnFail(R.drawable.default_portrait) // resource or drawable
                .cacheInMemory(true)
                .cacheOnDisk(true)
                .build();
        return options;
    ...
    public static void displayPortrait(String portraitUri, ImageView imageView) {
        if (StringUtil.isEmpty(portraitUri)) {
            imageView.setImageDrawable(Const.Application.getResources().getDrawable(R.drawable.default_portrait));
            return;
        }
    ...
    public static void displayImageXlarge(String originUri, ImageView imageView, final Drawable thumbnail, final ProgressBar progressBar) {
        if (StringUtil.isEmpty(originUri)) {
            imageView.setImageDrawable(Const.Application.getResources().getDrawable(R.drawable.common_default_photo));
            return;
        }
